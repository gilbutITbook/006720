...
// 원과 부채꼴(안쪽이 비어 있음)의 충돌 판정의 바탕 소스
// 
//------------------------------------------------------------
...
//------------------------------------------------------------
// 이하, 다이렉스X에 의한 표시 프로그램 

#include <stdio.h>
#include <windows.h>
#include <tchar.h>								// Unicode 멀티바이트 문제 관계 
...
{
	LARGE_INTEGER			nNowTime, nLastTime;		// 현재와 하나 전 시각
    ...
    g_hWnd = CreateWindow( _T( "D3D Sample" ), _T( "CheckHit_4_2(Secret:원과 중심이 빈 부채꼴, 바탕 소스)" ),
